<?php
namespace HayesMarketing\Gallery\Model\ResourceModel;

/**
 * Gallery photoset mysql resource
 */
class Photoset extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('hayesmarketing_gallery_photosets', 'id');
    }
    ...
    protected function _beforeSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        if (!$this->isValidPostUrlKey($object)) {
            throw new \Magento\Framework\Exception\LocalizedException(
                __('The photoset URL key contains capital letters or disallowed symbols.')
            );
        }

        if ($this->isNumericPostUrlKey($object)) {
            throw new \Magento\Framework\Exception\LocalizedException(
                __('The photoset URL key cannot be made of only numbers.')
            );
        }
